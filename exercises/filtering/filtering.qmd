...
**ANSWER** We get Julian Reese, whose trueshooting percentage was about 60.76%.
...
```{r}
matches_2025 |>
  filter(team == 'Maryland Terrapins, Terps', date <= "2025-09-04") |>
  group_by(team) |>
  summarise(
...
Although we are analyzing one more game in 2025 (7 compared to 6 in 2024), the 2025 squad is doing significantly better at shot creation than the 2024 squad. They had 20 more shot attempts, 15 more shots on goal, and have seen about a 6.43% increase in their attempts that have been shots on goal. 