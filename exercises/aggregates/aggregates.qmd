...
The file that we ran contains all the NBA players who played in the 2024-2025 season and specific facts about them - what team they play for, how many games they played, what their cumulative stats were, etc.
...
The code that we wrote broke all the players in our dataset into their respective positions and showed us how many players there are at each position. 
...
In this code of block, we expanded on the previous by asking R to arrange the different positions in descending order of how many players there are at each respective position. 
...
I think center is the most interesting position here since its standard deviation is the lowest. One reason for that might be because the NBA has had a bit of a resurgance of dominant big men in the last few years, but with a wrinkle: they're becoming excellent shooters as well as floor spacers. NBA basketball continues to grow more into a positionless game where they ask all players on the floor to be able to do everything - shoot, pass, rebound, etc. A possible story might be how stats amongst centers have changed since 2000.
