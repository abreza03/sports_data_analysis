...
Why on Earth has Georgia's attendance decreased? Over that time span they won back-to-back national championships and essentially overtook Alabama as the "big dogs" of the SEC. Google actually says that in 2024, the program set a new all-time record for average home attendance. They attribute the difference between the two years to a discrepancy between actual tickets sold and announced attendance. Could COVID concerns still be an issue with that? Maybe we take a look at reported COVID cases by year or perhaps crime reports around Sanford Stadium.
