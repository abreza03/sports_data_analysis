...
I'm not sure why it's not loading properly for me, but I have to assume that Associate Head Coach is a more common stepping stone. AHCs take on more leadership roles than most assistants because they usually have more experience/have a longer tenure. A lot of AHCs to basketball programs are what offensive & defensive coordinators are to football teams (these exist in basketball but are far less frequent).
...
In college sports, recruiting is everything, so long as you have the right coach in place. From an aspiring coach's perspectibve, getting experience in recruiting would be extremely valuable because you're able to understand what recruits want in a program. You also get to meet them ^ their families more as people rather than solely as athletes, which can go a long way for some. 

A potential story would be to see if there's a current head coach who used to work in recruiting that has an assistant coach who they helped recruit in that former role. I think that would be the epitome of what we're trying to build here. 
...
The vast majority of coaches have at least a few experiences under their belt before they're named a head coach. It differs for every person though. Some are naturally excellent coaches (perhaps they played for a long time or were raised by a coach), so they may be quicker to get to the top. Others don't want the pressure of a head coaching job for a while, so gain as much experience as they can before taking one. 
...
I'm interested in finding out the stories for those who went from head coach to interim head coach. I've never seen that before, and it's difficult to imagine what might have happened to cause that. 
---
...
I was wrong before. It's assistant coach. 

2. How important is recruiting experience for head coaches?

Extremely. We see that a ton of the coaches in our data set used to work in recruiting. 

3. What are the 2-3 most common career pathways to becoming a head coach?

Intern -> Assistant Coach (usually a few different assistant coaching positions) -> Head Coach

4. Are there any "non-traditional" pathways that appear in the data?

Yes, especially in our last block of code. It's extremely uncommon for those working in operations roles to become head coaches. I can understand the development side though. 
