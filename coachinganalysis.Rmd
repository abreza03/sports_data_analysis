...
I think we should include all head coaches. There are always good stories to tell about D2 and D3 schools, so excluding them feels like a bit of an injustice to me.
...
Once again, no. Kurt Warner was working at a grocery store prior to becoming Super Bowl MVP. You never know where talent can come from.
...
1. An investigative piece into who the coaches that Auburn and Mississippi State were, and why those places produced so many future head coaches. Was it a specific person or people? Was it their upbringing? 
2. A piece about Maryland: how many of the 13 future head coaches were developed by Frese? Were any players that she coached? How many were there prior to arrival at Maryland?
3. Which D3 school has the most head coach productions?
...
I wouldn't exclude these, I think some people are very deserving of an "early" head coaching nomination.
...
1. I really want to investigate this sole strength & conditioning coach who made the immediate jump to head coach. 
2. What are some of the stories of those who jumped from assistant coach to associate head coach? Perhaps a program wanted to keep them as their future head coach?
3. What's the story behind why some coaches left to become staff members? Need at the position? Better pay?
...
I wouldn't say any overlap is sufficient. I think one full year seems pretty reasonable.
...
1. We most certainly would have to do a Brenda Frese story. Who and where are her proteges? How long did they work together? Where did they meet?
2. Uh...Wes Moore??? Surely not the same guy, right?
3. Curious to see where Geno Auriemma fits into this. Feels strange that he's not on this list.
...
```
** NOT ABLE TO RUN THIS. NOT SURE WHY RSTUDIO WON'T LET ME RUN IGRAPH, GGRAPH, AND TIDYGRAPH. IT SAID THEY WERE INSTALLED WHEN I TRIED MULTIPLE TIMES **
---
...
1. A lot of the school-to-school numbers make sense based on geography. What about some of the ones that are across the country?
2. I'm interested in finding out how Charlotte came to produce 5 head coaches
3. I like the feeders vs destinations question. 
...
I think we should look at all of them, but I don't mind if we focus more on D1. 
...
1. Who are the nine coaches who moved from one Ivy to another?
2. Similar to big market vs small market teams in baseball, are there high-powered conferences often poaching from smaller ones?
3. 
...
Although I think it might be a little too much effort, like I said in the past, we shouldn't exclude potential really cool stories such as starting out at the high school or community college level.
...
1. Who are the coach/coaches who waited 35-40 years for their shot?
2. If I'm reading the graph correctly, there are some people who earned a head coaching job as their first job. What are their stories?
3. When considering the average of about 10-12 years before getting a head coaching position, what's the most common path?
...
1. What's the story with LSU? Only three coaches produced and the average time spent was about 1 and 2/3 years?
2. Frese seems to develop people very quickly, in less than three years. An analysis of some of those people and how they ended up would be a cool piece.
3. This one is beginning to answer my Auriemma question from earlier, but after being the coach there for so long, why do assistants under him not typically land jobs for over six years since joining the program?
...
1. I like the ladder of schools idea.
2. What makes GW, Texas Tech, and Wisconsin so attractive as to lure other D1 head coaches?
3. Some of the movement within Stepping Stone Moves seem like either even level jobs or downgrades in terms of program notoriety. What caused that? More influence on decisions, more money, etc.?
...
1. How many interim coaches would later be named head coach? Did they end up being successful in the full time role?
2. What makes the Associate Head Coach position so unique? i.e., why is it more common for assistants and head coaches to earn head coaching roles much more consistently? Are many of them content with where they are?
3. Curious to see if there are any coaches who earned 100 career victories at 4 different programs - I just researched this on the men's side recently (there are currently only two - Lefty Driesell and Steve Alford, whom Buzz Williams is now looking to join)
...
**Story #1:**
I mentioned a few different ideas for Frese stories. I like them all.
**Why this story:**
It's not only because it's our team, but through this data, it's been proven that she has been one of the better developers of coaches (high on the list of total future head coaches produced and her protoges earned a head coaching role in less than three years on average.)
---

**Story #2:**
What has made Auburn and Mississippi State such prolific developers of future head coaches?
**Why this story:**
36 is quite a lot of head coaches for just two programs to produce. I think this would be a very interesting read.
---

**Story #3:**
A comparison piece between those who became a head coach immediately versus those who waited 35/40 years for it. What are their stories?
**Why this story:**
I think this would be an excellent display that this field is a very non-linear one. It can be merit based, but it's usually based on early excellence or connections within the coaching network. I like that title: The Coaching Network. "You don't get to a head coaching role without a good amount of friends." Needs work but there's something there.
---
...
1. Some of the data was a little confusing in trying to answer this question, but it appeared as though there was somebody who immediately went from being a strength & conditioning coach to a head coach. That's something I'd want to explore.
2. Outside the program-to-program pipeline, are there coaches who send assistants to other coaches to be further developed?
3.